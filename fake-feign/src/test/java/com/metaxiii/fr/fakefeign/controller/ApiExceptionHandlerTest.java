...
class ApiExceptionHandlerTest {
  ...
  void handleAccessDeniedException() {
    final var exceptionWithMessage = new CustomException("there is a new custom " + "exception");
    ...
    assertDoesNotThrow(() -> {
      final var objectResponseEntity = apiExceptionHandler.handleAccessDeniedException(exceptionWithMessage);
